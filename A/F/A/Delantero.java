...
public class Delantero extends Jugador implements Contrato {

    private double porcentajeGoles;
    private int asistencias;

    public Delantero(String nombre, String apellido, LocalDate fechaNacimiento, int dni, Posicion posicion, Provincia provincia, HashSet<Equipo> historialDeEquipos, int numeroCamiseta,Equipo equipoActual, double porcentajeGoles, int asistencias) {
