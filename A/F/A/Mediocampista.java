...
public class Mediocampista extends Jugador implements Contrato{
    ...
    public Mediocampista(String nombre, String apellido, LocalDate fechaNacimiento, int dni, Posicion posicion, Provincia provincia, HashSet<Equipo> historialDeEquipos,Equipo equipoActual, int numeroCamiseta, double porcentajeGoles, int asistencias) {
